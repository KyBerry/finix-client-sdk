(() => {
  ...
  var d = new URL(document.currentScript ? document.currentScript.src : "https://js.finix.com/latest"),
    l = d.pathname.split("/").slice(0, -1).join("/"),
    u = "".concat(d.origin + l, "/payment-fields/index.html?"),
