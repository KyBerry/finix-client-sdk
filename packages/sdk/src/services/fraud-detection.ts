...
export class FraudDetection {
   ...
   */
  public static async setup(merchantId: string, environment: FinixEnvironment): Promise<string> {
   ...
   */
  private static async createSession(merchantId: string, environment: FinixEnvironment): Promise<string> {
